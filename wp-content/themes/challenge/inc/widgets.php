	...
	function understrap_widgets_init() {
		register_sidebar(
			array(
				...
				'id'            => 'rightsideheader',
				'description'   => __( 'Widget on the right side of the header', 'understrap' ),
				'before_widget' => '<div id="%1$s" class="right-side-header-widget">',
				'after_widget'  => '</div><!-- .right-side-header-widget -->',
				'before_title'  => '',
				'after_title'   => '',
			)
		);
